...
def navier_stokes_2d(w0, f, visc, T, delta_t=1e-4, record_steps=1):
    ...
    w_h = torch.fft.rfftn(w0, 2, norm="forward")

    #Forcing to Fourier space
    f_h = torch.fft.rfftn(f, 2, norm="forward")
    ...
    for j in range(steps):
        ...
        q = torch.fft.irfftn(q, 2, norm="forward")
        ...
        v = torch.fft.irfftn(v, 2, norm="forward")
        ...
        w_x = torch.fft.irfftn(w_x, 2, norm="forward")
        ...
        w_y = torch.fft.irfftn(w_y, 2, norm="forward")

        #Non-linear term (u.grad(w)): compute in physical space then back to Fourier space
        F_h = torch.fft.rfftn(q*w_x + v*w_y, 2, norm="forward")
        ...
        if (j+1) % record_time == 0:
            ...
            w = torch.fft.irfftn(w_h, 2, norm="forward")
