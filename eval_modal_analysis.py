...
if __name__ == "__main__":
    ...
    # ax[1,1].set_title("Second Mode  Pred")
    # ax[2,0].set_title("Third Mode  Target")
    # ax[2,1].set_title("Third Mode  Pred")
    # ax[0,2].set_title("First Mode ConvLSTM")
    # ax[1,2].set_title("Second Mode ConvLSTM")
    # ax[2,2].set_title("Third Mode ConvLSTM")
    for i in range(3):
        for j in range(3):
            ax[i,j].axis("off")
    fig.savefig("PCA3.pdf",bbox_inches="tight",transparent=True)
