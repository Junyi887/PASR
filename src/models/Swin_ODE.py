...
class Swin_ODE(nn.Module):
    ...
    def __init__(self, img_size=64, patch_size=1, in_chans=3,
                 ...
                 ,mean = [0],std = [1],  
                 ode_method = "euler",num_ode_layers = 4,time_update = "NODE",ode_kernel_size = 3,ode_padding = 1,final_tanh =False,aug_dim_t = None,
                pre_trained = False, **kwargs):
        super(Swin_ODE, self).__init__()
