...
if __name__ == "__main__":
    ...
    train_loader, val1_loader, val2_loader, test1_loader, test2_loader  = getData(data_name= 'decay_turb_lrsim',batch_size= 30,data_path="../decay_turb_lrsim",in_channels=1,timescale_factor= 10)
